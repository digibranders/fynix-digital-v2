...
export const metadata: Metadata = {
  title: "B2B Growth & Web Development FAQs",
  description:
    "Answers to the questions B2B leaders most often ask Fynix about website performance, SEO, lead generation, and unified growth systems.",
