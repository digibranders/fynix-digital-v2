      ...
      <Container>
        <div className="max-w-[820px] mb-16 md:mb-20">
          <h2 className="text-[2.15rem] sm:text-[2.65rem] lg:text-[3.05rem] leading-[1.08] font-medium tracking-[-0.026em] text-[#0F0E0C]">
            An honest word,{" "}
            <span className="italic font-normal text-[#2F4B3A]">before you register.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
          <Reveal>
            <p className="text-[1.45rem] italic font-normal text-[#0F0E0C] pb-4 border-b border-[#DDD3BC]">
              This is for you if
            </p>
            <ul className="mt-6 space-y-5">
              {FOR.map((item, i) => (
                <li key={i} className="flex gap-4 text-[15.5px] leading-[1.6]">
                  <span className="font-serif text-[16px] italic font-normal text-[#2F4B3A] tnum pt-0.5 shrink-0 min-w-[24px]">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="text-[#0F0E0C]">{item}</span>
                </li>
              ))}
            </ul>
          </Reveal>
          ...
          <Reveal delay={100}>
            <p className="text-[1.45rem] italic font-normal text-[#8B857A] pb-4 border-b border-[#DDD3BC]">
              This is not for you if
            </p>
            <ul className="mt-6 space-y-5">
              {NOT_FOR.map((item, i) => (
                <li key={i} className="flex gap-4 text-[15.5px] leading-[1.6]">
                  <span className="font-serif text-[16px] italic font-normal text-[#8B857A] tnum pt-0.5 shrink-0 min-w-[24px]">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="text-[#4A4640]">{item}</span>
                </li>
              ))}
            </ul>
          </Reveal>
